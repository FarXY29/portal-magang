<x-guest-layout>
    ...
    <div class="mb-4 text-center">
        <h2 class="text-xl font-bold text-gray-800">Daftar sebagai Dosen/Guru</h2>
        <p class="text-sm text-gray-600">Akun khusus untuk memantau mahasiswa/siswa bimbingan Anda.</p>
    </div>
